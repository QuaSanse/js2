...
function f1() {
    let inValue = document.querySelector('.i-1').value;

    d1[d1.length] = inValue;
    showArr('.out-1', d1);
}
...
function f4() {
    let inValue = document.querySelector('.i-4').value;
    d1.push(inValue);
    showArr('.out-4', d1);
}
...
function f5() {
    let inValue = document.querySelector('.i-5').value;
    d1.unshift(inValue);
    showArr('.out-5', d1);
}
...
function f6() {
    let inValue = document.querySelector('.i-6').value;

    d6[d6.length] = inValue;
    showArr('.out-6', d6);
}
...
function f8() {
    let emptyArr = [];
    let inValue = document.querySelector('.i-8').value;
    emptyArr[0] = inValue;
...
function f11() {
    let inValue = +document.querySelector('.i-11').value;
    document.querySelector('.out-11').innerHTML = d11.indexOf(inValue);;
}
...
function f15() {
    let inValue = +document.querySelector('.i-15').value;
    let out = '';

    for (let i = 0; i < d15.length; i++) {
        if (out == true) break;

        switch (d15[i] === inValue) {
