...
let goods2 = new Goods('Тыква', '100 руб', '2.png', '5')
...
let goods3 = new Goods2('Маска', '200 руб', '1.png', '5', true);
goods3.draw('.out-6');
...
let validOut = new Valid('email@net.ru', '12345');
validOut.validate();
console.log(validOut.isValid);
...
let validOut2 = new Valid('email@net.ru', '1234567');
validOut2.validate();
console.log(validOut2.isValid);
...
let valid3 = new Valid2('email@net.ru', '1234567');
valid3.validate();
console.log(valid3);